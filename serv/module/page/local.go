...
// func (this *LocalModelStruct) GetLocalInfo() interface{} {
// 	var data = make(map[string]interface{})
// 	var LocalDataTemp = make(map[string]int64)

// 	for k, v := range LocalData {
// 		LocalDataTemp[k] = v.TTL
// 	}

// 	data["total_key"] = len(LocalData)
// 	data["indexs"] = LocalDataTemp
// 	return data
// }
